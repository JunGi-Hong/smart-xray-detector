...
export default function Navbar(props) {//props로 Dashboard컴포넌트에서 사용자 이름 정보 받아오기
    ...
    return (
        <header className='main-header'>
            <div className='header-left'>{props.name + ' 님'/*props.name*/}</div>
            ...
            <nav className='header-right'>
                ...
                <Link to='/user/fix' className='nav-item'>
